          ...
          <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <Link to="/" className="flex items-center h-full gap-3">
                {siteData.company.logo ? (
                  <div 
                    ...
                    style={{ backgroundColor: siteData.branding.logoBackgroundColor || 'var(--color-primary)' }}
                  >
                    <img
                  ...
                  <div className="h-full px-3 flex items-center justify-center" style={{ backgroundColor: siteData.branding.logoBackgroundColor || 'var(--color-primary)' }}>
              ...
              <div className="hidden md:flex items-center gap-8">
                ...
                <Link
                  to="/carrito"
                  className="relative p-2 hover:bg-[var(--color-card)] transition-colors"
                >
