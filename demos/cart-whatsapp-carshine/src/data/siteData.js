export const siteData = {
  ...
  branding: {
    ...
    carouselAspectRatio: 'aspect-[3/1]',
    carouselMaxHeight: 'max-h-[300px]',
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Aceite Semisintético', href: '/productos?cat=Aceite+Semisintetico' },
          { label: 'Aceite Sintético', href: '/productos?cat=Aceite+Sintetico' },
      ...
      },
      {
        title: 'Contacto',
        links: [
          { label: 'hola@carshine.com.ar', href: 'mailto:hola@carshine.com.ar' },
