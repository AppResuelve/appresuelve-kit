    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full max-w-sm px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-cyan-500 text-sm"
        />
      </div>
