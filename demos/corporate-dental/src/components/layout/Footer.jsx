            ...
            <div className="flex items-center gap-3 mb-4">
              {siteData.company.logo ? (
                <img
                  ...
                  style={{ backgroundColor: siteData.branding.logoBackgroundColor || 'var(--color-primary)', padding: '4px' }}
                />
              ) : (
                <div className="h-20 w-20 rounded-md bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-secondary)] flex items-center justify-center">
              ...
              {(!siteData.navbar.logoOnly) && (
                <span className="text-xl font-bold font-[family-name:var(--font-heading)] text-[var(--color-text-primary)]">
