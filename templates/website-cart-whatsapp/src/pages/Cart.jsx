            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 rounded-2xl border border-[var(--color-border)] bg-[var(--color-card)] p-6">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full px-8 py-4 rounded-2xl bg-green-500 text-white font-semibold hover:bg-green-600 transition-colors"
                >
